...
When publishing, it is helpful to ensure all plots have similar
formatting. To do this we can create a custom function with our
preferences for the theme. Remember the structure of a function is:
...
::: callout-note
You can also combine multiple arguments within the same theme()
function:
...
can just put the code inside the `{}`:
